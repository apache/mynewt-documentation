...
.. toctree::
   ...
   Enabling an Off-Board Sensor in an Existing Application <sensor_nrf52_bno055>
   Changing the Default Configuration for a Sensor <sensor_offboard_config>
   Developing an Application for an Onboard Sensor <sensor_thingy_lis2dh12_onb>
   Enabling OIC Sensor Data Monitoring in an Existing Application <sensor_oic_overview>
